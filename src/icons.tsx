...
/** Info circle (About — circle with i) */
...
/** Wrench (Troubleshooting / fix) */
export function IconWrench(props: SVGProps<SVGSVGElement>) {
  return (
    <svg className={iconClass} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M14.7 6.3a1 1 0 000 1.4l1.6 1.6a1 1 0 001.4 0l3.77-3.77a6 6 0 01-7.94 7.94l-6.91 6.91a2.12 2.12 0 01-3-3l6.91-6.91a6 6 0 017.94-7.94l-3.76 3.76z" />
    </svg>
  )
}

/** GitHub mark (Invertocat silhouette) */
export function IconGitHub(props: SVGProps<SVGSVGElement>) {
  return (
    <svg className={iconClass} viewBox="0 0 24 24" fill="currentColor" {...props}>
