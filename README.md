...
- **Canvas controls** — Scroll to pan, Ctrl+Scroll to zoom (up to 400%), right-click drag to pan. Custom scrollbars, Align Assist guides/snapping, and fit-to-view. Optional **inches/cm** display for grid, rulers, and dimension labels (Canvas menu → Show in cm); layout and zoom stay in inches; diagonal sizes remain in inches.
...
| Rulers & grid in cm | Canvas menu (top-right ⋮) → **Show in cm** (display-only; layout and zoom stay in inches) |
...
- **Physical space (inches)** — The canvas grid and layout. 1 canvas unit = 1 physical inch. You can switch the **grid and ruler** to display in cm (Canvas menu → **Show in cm**); layout, snap, and zoom stay in inches. Layout dimensions in the toolbar and preset cards follow the chosen display unit; diagonal sizes remain in inches.
